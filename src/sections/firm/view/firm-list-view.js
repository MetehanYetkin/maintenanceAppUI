...
//
import FirmTableRow from '../firm-table-row';
...
const TABLE_HEAD2 = [
  { id: 'firmName', label: 'Firma Adı' }, 
  { id: 'taxNumber', label: 'Vergi Numarası' },
  { id: 'address', label: 'Address' },
  { id: 'email', label: 'Email' },
  { id: 'telephoneNumber', label: 'Telefon Numarası' },
  { id: '' },
];
...
export default function FirmListView() {
